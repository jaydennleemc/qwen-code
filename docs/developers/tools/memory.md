...
The tool appends the provided `fact` to your context file in the user's home directory (`~/.qwen_local/QWEN.md` by default). This filename can be configured via `contextFileName`.
