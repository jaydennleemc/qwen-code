...
```json
{
  ...
  "yolo": true,
  "source_repo": ".",
  "worktree_base": "~/.qwen_local/worktrees",
  "outputs_dir": "./outputs",
...
| `worktree_base` | string | ~/.qwen_local/worktrees | Base directory for git worktrees              |
  ...
  "runs": [
    {
      ...
      "status": "succeeded",
      "worktree_path": "~/.qwen_local/worktrees/run-abc123",
